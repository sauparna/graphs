extern long dijkstra(Vertex *uu, Vertex *vv, Graph *gg, long (*hh)(Vertex *)); /* procedure to calculate the shorted paths */
extern void print_dijkstra_result(Vertex *vv); /* procedure to display the answer */
...
extern void (*requeue)(Vertex *, long); /* decrease the key of an element in the queue */
